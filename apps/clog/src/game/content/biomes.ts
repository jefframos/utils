...
export const BIOME_DEFINITIONS: Record<BiomeId, BiomeDefinition> = {
    0: { name: 'Asteroid', fill: 0x34313a, edge: 0x80798c, glow: 0x56515f, revealRadius: 2, defaultHp: 1 },
    ...
    6: { name: 'Cave', fill: 0x222531, edge: 0x6f7a93, glow: 0x3d4a63, revealRadius: 2, defaultHp: 14 },
    7: { name: 'Crystal Cave', fill: 0x2d2a55, edge: 0xcbc2ff, glow: 0x8c7dff, revealRadius: 4, defaultHp: 8 },
    8: { name: 'Danger', fill: 0x3f171d, edge: 0xff5c6c, glow: 0xb7283c, revealRadius: 2, defaultHp: 4 },
};
